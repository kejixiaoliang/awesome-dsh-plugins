...
| # | Plugin | Description | ⭐ |
|---|---|---|---|
| 🥇 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | Official core repo: "everything is a plugin", driven by Cordis. | 228438 |
| 🥈 | [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | Modern DeepSeek Harness desktop experience | 27444 |
| 🥉 | [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | Community curated list (105 plugins + sites + badges). | 16113 |
...
| 5 | [dsh-desktop](https://github.com/dataelement/dsh-desktop) | Cross-platform desktop app | 7319 |
...
| 7 | [dsh-market](https://github.com/dsh-market/dsh-market) | The plugin market inside DSH: a Settings page to browse and search the full community catalog by category, with confirmed one-click installs and an installed-plugins view. | 4107 |
...
| 14 | [🏛️ Official & Meta](plugins/official-meta.md) | 11 | core repo, awesome lists, compat radar, community hub |
...
| [dsh-desktop](https://github.com/dataelement/dsh-desktop) | 7319 | Cross-platform desktop app |  |
...
| [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 27444 | Modern DeepSeek Harness desktop experience |  |
...
| [modsearch](https://github.com/liustack/modsearch) | 499 | Web search bridge for text-only agents: ask the web or X, get structured JSON evidence (search, fetch, citations). | `dsh plugin add @liustack/modsearch` |
...
| [dsh-market](https://github.com/dsh-market/dsh-market) | 4107 | The plugin market inside DSH: a Settings page to browse and search the full community catalog by category, with confirmed one-click installs and an installed-plugins view. | `dsh plugin add github:dsh-market/dsh-market` |
...
<details>
<summary>🏛️ Official & Meta · 11</summary>

| Plugin | ⭐ | Description | Install |
|---|---|---|---|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 228438 | Official core repo: "everything is a plugin", driven by Cordis. |  |
...
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | 16113 | Community curated list (105 plugins + sites + badges). |  |
...
| [aixwork/alldsh](https://github.com/aixwork/alldsh) |  | AllDSH — a two-layer directory: hand-reviewed curated listings with verification levels and checkable evidence, plus a nightly audited index of the GitHub dsh-plugin topic (rejection reasons and coverage counts published). Bilingual EN/ZH site at alldsh.com. |  |
