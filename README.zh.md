...
| # | 插件 | 描述 | ⭐ |
|---|---|---|---|
| 🥇 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 官方核心仓库：「一切皆插件」，Cordis 驱动 | 216706 |
| 🥈 | [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 现代化 DeepSeek Harness 桌面端体验 | 24649 |
| 🥉 | [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | 社区精选列表（105 插件 + 站点 + 徽章） | 14976 |
| 4 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | DSH Web UI 插件与皮肤集合：任务看板、Git 图谱、右侧面板、移动端远程、皮肤中心 | 7198 |
| 5 | [deepseek-ai/awesome-deepseek-agent](https://github.com/deepseek-ai/awesome-deepseek-agent) | 官方 Agent 精选列表 | 6049 |
| 6 | [dsh-desktop](https://github.com/dataelement/dsh-desktop) | 跨平台桌面应用 | 4607 |
| 7 | [modlens](https://github.com/liustack/modlens) | DSH 首个视觉插件：粘贴图片返回结构化 JSON 证据（OCR/布局/语义） | 3922 |
| 8 | [dsh-market](https://github.com/dsh-market/dsh-market) | DSH 可视化插件市场：浏览/搜索/一键安装 | 3465 |
| 9 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 侧边栏完整工作台：文件渲染编辑/终端/Git/子代理，支持三方注册 Tab | 3448 |
| 10 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | Claude Code 风格全屏交互终端：像素鲸鱼顶栏、流式思考展开、双击 Esc 回滚、上下文/TPS 仪表 | 2896 |
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 507 | Codex 风格 `@file` 文件引用，输入框里直接搜索并引用工作区文件 | `dsh plugin add dsh-at-file` |
...
| [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) | 190 | 让 AI 帮你连数据库、写 SQL | `dsh plugin add @deepseek-ai/dsh-data-agent` |
...
| [dsh-plugin-mineru](https://github.com/HuanLinOTO/dsh-plugin-mineru) | 46 | 向模型暴露 MineRU 文档解析工具 | `dsh plugin add @huanlin/dsh-plugin-mineru` |
...
| [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) | 123 | 逆向工程、授权渗透测试与安全研究技能路由包（85 个 SKILL.md，仅限授权测试） | `dsh plugin add github:dhicoc/dsh-reverse-skill` |
...
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1976 | DSH Web 鲸鱼娘皮肤系列（深海女仆工坊） |  |
...
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3448 | 侧边栏完整工作台：文件渲染编辑/终端/Git/子代理，支持三方注册 Tab | `dsh plugin add dsh-better-sidebar` |
...
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 112 | 选中文字→批注→回车随消息发送，回复按批注逐条对照 | `dsh plugin add @omdsh-dev/dsh-annotation` |
...
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 7198 | DSH Web UI 插件与皮肤集合：任务看板、Git 图谱、右侧面板、移动端远程、皮肤中心 | `dsh plugin add dsh-web-ui` |
...
| [dsh-easyrewrite](https://github.com/Renzic-Stone/DSH-EasyRewrite) | 105 | DSH Web 用户消息气泡内联编辑与撤回：惰性提交、无痕替换、版本翻页器、草稿自动备份、三语 i18n | `dsh plugin add dsh-easyrewrite` |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 427 | 助手回复内渲染交互式 UI 组件：布局、图表、表单、测验、mermaid、3D 场景 | `dsh plugin add @omdsh-dev/dsh-genui` |
...
| [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 168 | OpenPencil 设计预览与编辑（Agent 操作真实设计画布） | `dsh plugin add @zseven-w/dsh-openpencil` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2896 | Claude Code 风格全屏交互终端：像素鲸鱼顶栏、流式思考展开、双击 Esc 回滚、上下文/TPS 仪表 | `dsh plugin add dsh-cc-tui` |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 268 | DSH 终端 TUI（天枢） | `dsh plugin add @huiliyi37/dsh-tianshu-tui` |
...
| [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 308 | 一站式社区发行版：TUI、桌面端与 Web UI 三种形态统一体验 | `dsh plugin add @oh-dsh/desktop` |
| [deepseek-harness-desktop](https://github.com/chyra-moon/deepseek-harness-desktop) | 17 | Windows 原生桌面壳：1:1 官方 Web UI + 内置服务器托管 + 托盘驻留 |  |
...
| [dsh-desktop](https://github.com/dataelement/dsh-desktop) | 4607 | 跨平台桌面应用 |  |
...
| [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 24649 | 现代化 DeepSeek Harness 桌面端体验 |  |
| [Deepseek-Harness-Desktop](https://github.com/ChisaAlter/Deepseek-Harness-Desktop) | 161 | Electron 桌面壳：主题/背景图/托盘，对话仍走官方 dsh web | `dsh plugin add deepseek-harness-desktop` |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 199 | Windows 轻量启动器：开机自启 + 独立小窗口 |  |
...
| [dsh-work](https://github.com/vibeinging/deepseek-harness-desktop-app) | 584 | 本地 AI 工作桌面：Session/文件/数据分析/MCP/Office 一体化 |  |
...
| [deepseek-harness-tui](https://github.com/openma-ai/deepseek-harness-tui) | 70 | Rust/ratatui 编写的 DSH 终端 TUI | `dsh plugin add github:openma-ai/deepseek-harness-tui` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1467 | AgentTeams 多智能体团队协作 | `dsh plugin add dsh-agent-teams` |
| [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) | 117 | 把 UltraCode 式多 Agent 调度带给 DSH：可生成/保存/治理/观察/恢复的 Workflow 层 | `dsh plugin add @dsh-external/workflow` |
...
| [dsh-plugin-yet-another-subagent](https://github.com/HuanLinOTO/dsh-plugin-yet-another-subagent) | 15 | 可配置子代理 profiles + 实时工具调用/token 显示 + 子会话跳转 | `dsh plugin add @huanlin/dsh-plugin-yet-another-subagent` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 292 | 跨会话长期记忆 + 后台自我进化（五轨记忆/git 分支感知/技能进化） |  |
| [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) | 76 | 模型驱动上下文压缩（ACP）：模型决定何时压缩（移植自 billion-context-pi） |  |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 349 | Mnemon 本地三层记忆（Runtime Memory/可检索文档/受监督 Memory Spaces） | `dsh plugin add dsh-mnemon` |
...
| [dsh-meow-memory](https://github.com/Phant0Meow/dsh-meow-memory) | 84 | 跨会话项目记忆：SQLite 分层存储 + 关键词/语义检索，逐消息命中注入与窗口期整理 | `dsh plugin add github:Phant0Meow/dsh-meow-memory` |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 1307 | 上下文洞察面板：展示模型上下文窗口的构成与演化 | `dsh plugin add dsh-context` |
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 114 | 对话回退：基于持久 Change Ledger 回滚会话与工作区状态 | `dsh plugin add @dsh-external/turn-rewind` |
...
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 142 | 13 源全保真导入（Claude Code/Codex/ChatGPT/Cursor/Gemini/Reasonix/opencode/ZCode/Grok Build/OpenClaw/Pi/Hermes/Kimi）历史会话为可续聊 DSH 会话 | `dsh plugin add dsh-chat-import` |
| [dsh-claude-move](https://github.com/PerryLink/dsh-claude-move) | 19 | 迁移 Claude Code 会话/记忆/技能/CLAUDE.md 到 DSH | `dsh plugin add dsh-claude-move` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [modlens](https://github.com/liustack/modlens) | 3922 | DSH 首个视觉插件：粘贴图片返回结构化 JSON 证据（OCR/布局/语义） | `dsh plugin add @liustack/modlens` |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 866 | 纯文本模型的视觉工具箱：图片问答、长截图 OCR、UI 还原、定位、像素对比、Artifacts | `dsh plugin add @dsh-external/dsh-vision-toolkit` |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 1191 | 同上，agent 通用视觉工具箱与技能（多图理解/GUI 自动化） |  |
...
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1089 | 纯文本模型的视觉路由：免费视觉链 + 像素级视觉工具（问答/定位/裁剪/OCR） | `dsh plugin add dsh-vision-router` |
...
| [dsh-automation](https://github.com/titanwings/dsh-automation) | 89 | 定时任务：Coding 任务按计划在全新 Agent Session 中运行 | `dsh plugin add @dsh-external/dsh-automation` |
...
| [dsh-advisor](https://github.com/omdsh-dev/dsh-advisor) | 19 | 副模型每轮被动审查并注入见解 | `dsh plugin add dsh-advisor` |
...
| [dsh-ramify](https://github.com/yanglongyun/dsh-ramify) | 12 | 创意分支画布：树状工作区生成、对比、迭代多个方案 | `dsh plugin add @ramify/dsh-ramify` |
...
| [dsh-auto-continue](https://github.com/HsiangNianian/dsh-auto-continue) | 81 | 自动续传：网络中断后自动发「继续」恢复请求 | `dsh plugin add github:HsiangNianian/dsh-auto-continue` |
...
| [dsh-telegram](https://github.com/ben7am1n/dsh-telegram) | 4 | Telegram 运行时适配器（per-chat 会话、allowlist 认证） | `dsh plugin add dsh-telegram` |
...
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1234 | 一个设置入口统一接入飞书/微信/钉钉/企业微信/QQ/Slack/Telegram/Discord/WhatsApp 机器人，支持扫码、Manifest 或凭据绑定 · `npx -y github:xmanrui/dsh-im install` |  |
...
| [dsh-web-ui-notify](https://github.com/bill9109/dsh-web-ui-notify) | 26 | 桌面通知提醒 | `dsh plugin add @bill9109/dsh-web-ui-notify` |
...
| [dsh-ssh](https://github.com/UynajGI/dsh-ssh) | 10 | SSH 远程执行（ProxyJump 链、SFTP 文件系统、PTY） |  |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 603 | Chrome 侧边栏扩展，让 DSH 直接操作你的浏览器（无需视觉能力） |  |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 135 | 把 ego-lite（给 AI Agent 的 Chromium）接入 DSH，13 个结构化 ego_* 工具 |  |
...
| [deepseek-pp](https://github.com/zhu1090093659/deepseek-pp) | 1819 | 浏览器扩展 AI Agent 工作区，内置 MCP 与记忆 |  |
...
| [modsearch](https://github.com/liustack/modsearch) | 438 | CLI 搜索工具：把搜索查询转结构化 web 证据 JSON | `dsh plugin add @liustack/modsearch` |
...
| [dsh-super-injector](https://github.com/yjh051108/dsh-super-injector) | 159 | 超级模组注入器：运行时注入本地插件包（junction + loader.create，热重载） | `dsh plugin add @dsh-external/dsh-super-injector` |
| [oh-my-dsh](https://github.com/LaplaceYoung/oh-my-dsh) | 57 | 面向 DSH 的插件生态：700+ 插件，扩展接缝注册不改 agent-loop |  |
| [dsh-plugin-hub](https://github.com/Noob-stupid/dsh-plugin-hub) | 81 | 插件管理面板 + 多源市场：一键启停（HMR 生效）、GitHub/Gitee/自定义源并行搜索、静态索引市场（500+ 插件 / 300 技能）、技能安装/停用/删除、套装一键装配、框架一键升级 | `dsh plugin add dsh-plugin-hub` |
...
| [dsh-evolve](https://github.com/william-jin-cmu/dsh-evolve) | 12 | 自进化：agent 会话内给自己热挂载/卸载持久化插件 | `dsh plugin add @dsh-external/dsh-evolve` |
...
| [deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker) | 69 | 社区 Docker/K8s 打包（加固镜像 + Compose + Helm） |  |
...
| [dsh-market](https://github.com/dsh-market/dsh-market) | 3465 | DSH 可视化插件市场：浏览/搜索/一键安装 | `dsh plugin add github:dsh-market/dsh-market` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [dsh-gomoku](https://github.com/omdsh-dev/dsh-gomoku) | 22 | 与 AI 下五子棋，也可双 AI 对弈比棋力 | `dsh plugin add @deepseek-ai/dsh-gomoku` |
| [dsh-minigames](https://github.com/lhh010/dsh-minigames) | 29 | 右侧 18 款离线小游戏面板（恐龙跳一跳/俄罗斯方块/扫雷/2048…） | `dsh plugin add @dsh-external/dsh-minigames` |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 317 | 桌面宠物鲸鱼娘（QQ 宠物形态，可拖拽/投喂/玩耍） | `dsh plugin add whale-girl` |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 613 | 2005 中文站点风格整活广告（侧栏/信息流/弹窗，素材全虚构） | `dsh plugin add @dsh-external/dsh-ads` |
...
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 56 | OpenMAIC 教学：课堂、幻灯片、交互组件、苏格拉底式教学 | `dsh plugin add @openmaic/dsh-openmaic` |
| [dsh-scholar](https://github.com/lzszq/dsh-scholar) | 43 | 学术助手插件 | `dsh plugin add @dsh-scholar/research-plugin` |
...
| [notes](https://github.com/zhaoolee/notes) | 160 | 开源版锤子便签：导出 DSH 会话为便签图片，支持 skill 调用 ⚠️ 无 license 文件 |  |
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 267 | DSH 会话费用统计（本会话/当日/历史 + 官方价格同步） | `dsh plugin add github:Han-1413141/dsh-cost-meter` |
...
| 插件 | ⭐ | 描述 | 安装命令 |
|---|---|---|---|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 216706 | 官方核心仓库：「一切皆插件」，Cordis 驱动 |  |
| [deepseek-ai/awesome-deepseek-agent](https://github.com/deepseek-ai/awesome-deepseek-agent) | 6049 | 官方 Agent 精选列表 |  |
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | 14976 | 社区精选列表（105 插件 + 站点 + 徽章） |  |
| [bruc3van/awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 320 | 「30 秒找到适合你的插件」，带场景说明 + 505 全量快照 |  |
| [0xsline/awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 1026 | DSH 生态精选：插件/工具/基础设施 |  |
| [AdamPlatin123/awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 1456 | 目录 + **每日兼容性雷达**（四维检查 + 运行实测） |  |
| [Alex-Yanggg/awesome-DSH-plugin](https://github.com/Alex-Yanggg/awesome-DSH-plugin) | 96 | 覆盖生产力/扩展/调试/自定义开发的分类 catalog |  |
