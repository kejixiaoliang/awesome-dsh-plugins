...
| [dsh-code-poem](https://github.com/weibaohui/dsh-code-poem) |  | 代码如诗：4598 条古诗词、成语、龙文鞭影典故随机成笺，随会话事件自动浮现（回合结束/工具报错时送你一句），可 ❤ 收藏、展开看释义与故事，宣纸墨色的阅读卡片 | `dsh plugin add @weibaohui/dsh-code-poem` |
