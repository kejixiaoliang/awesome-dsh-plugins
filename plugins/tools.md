...
- [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) — Codex 风格 `@file` 文件引用，输入框里直接搜索并引用工作区文件 ⭐457 · `dsh plugin add dsh-at-file`
...
- [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) — 让 AI 帮你连数据库、写 SQL ⭐152 · `dsh plugin add @deepseek-ai/dsh-data-agent`
...
- [dsh-plugin-mineru](https://github.com/HuanLinOTO/dsh-plugin-mineru) — 向模型暴露 MineRU 文档解析工具 ⭐41 · `dsh plugin add @huanlin/dsh-plugin-mineru`
