...
- [ZK-Andy/dsh-continual-evolve](https://github.com/ZK-Andy/dsh-continual-evolve) — 持续自进化:版本化、可审计、可回滚的 harness 状态（提示词/记忆/技能/子代理规格）沉淀自会话轨迹,带审查门禁与技能热加载 ⭐5 · `dsh plugin add dsh-continual-evolve`
