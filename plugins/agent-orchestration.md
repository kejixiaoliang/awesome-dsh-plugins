...
- [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) — AgentTeams 多智能体团队协作 ⭐1064 · `dsh plugin add dsh-agent-teams`
- [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) — 把 UltraCode 式多 Agent 调度带给 DSH：可生成/保存/治理/观察/恢复的 Workflow 层 ⭐107 · `dsh plugin add @dsh-external/workflow`
...
- [dsh-agent-team](https://github.com/wowyuarm/dsh-agent-team) — 帮 human 有序管理任务、把 agents 用成真正的协作者：持久身份 Agent、Workspace 按项目组织、Channel 职责分派、Task Thread 串联推进 ⭐1 · `dsh plugin add @wowyuarm/dsh-agent-team`
