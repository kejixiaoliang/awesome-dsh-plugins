...
- [dsh-automation](https://github.com/titanwings/dsh-automation) — 定时任务：Coding 任务按计划在全新 Agent Session 中运行 ⭐72 · `dsh plugin add @dsh-external/dsh-automation`
...
- [dsh-plannotator](https://github.com/titanwings/dsh-plannotator) — 计划批注：选中计划原文逐条批注并回送结构化反馈 ⭐8 · `dsh plugin add @dsh-external/dsh-plannotator`
...
- [dsh-llm-fallbacks](https://github.com/omdsh-dev/dsh-llm-fallbacks) — 基于角色的模型重试/备用策略 ⭐15 · `dsh plugin add dsh-llm-fallbacks`
...
- [dsh-auto-continue](https://github.com/HsiangNianian/dsh-auto-continue) — 自动续传：网络中断后自动发「继续」恢复请求 ⭐36 · `dsh plugin add github:HsiangNianian/dsh-auto-continue`
